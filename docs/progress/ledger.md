...
| 1 — Repository and CI foundation | NOT_STARTED | Java, Python, React, Compose, CI, formatting, linting | — |
| 2 — Identity, organisations and projects | NOT_STARTED | Authentication, roles, tenant model, frontend shell | — |
| 3 — Event ingestion | NOT_STARTED | Event sources, signatures, schemas, idempotency | — |
| 4 — Pipeline runs and timeline | NOT_STARTED | Normalisation, aggregation, timeline API/UI | — |
| 5 — Incident correlation | NOT_STARTED | Correlation engine, state machine, incident UI | — |
| 6 — Logs and evidence | NOT_STARTED | Log fragments, search, citations, viewer | — |
| 7 — Deterministic diagnosis | NOT_STARTED | Redaction, injection checks, rules, tests | — |
| 8 — Historical retrieval | NOT_STARTED | Reviewed resolution store and similarity retrieval | — |
| 9 — AI summaries | NOT_STARTED | Provider interface, structured output, citations, abstention | — |
